...
export default class SelectActionHandler {
    ...
    public static translateBackendToUBC(
        ...
        // Ensure buyer @context is main (per latest schema updates - on_init, on_status, etc. all use main)
        ...
        const ubcOnSelectPayload: UBCOnSelectRequestPayload = {
            ...
            message: {
                order: {
                    ...
                    "beckn:buyer": buyerWithMainContext as any, // Required per schema (lines 1127-1136), @context updated to main
